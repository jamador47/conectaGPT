...
// ==============================|| DASHBOARD MENU ITEMS WITH i18n ||============================== //

const getDashboardMenuItems = (t) => ({
    id: 'dashboard',
    title: '',
    type: 'group',
    children: [
        {
            ...
            children: [
                ...
                {
                    id: 'marketplaces',
                    title: t('navigation.marketplaces'),
                    type: 'item',
                    url: '/marketplaces',
                ...
                {
                    id: 'document-stores',
                    title: t('navigation.document_stores'),
                    type: 'item',
                    url: '/document-stores',
        ...
        {
            id: 'management',
            title: t('navigation.user_workspace_management'),
            type: 'group',
            children: [
                {
                    id: 'sso',
                    title: t('navigation.sso_config'),
                    type: 'item',
                    url: '/sso-config',
                ...
                {
                    id: 'login-activity',
                    title: t('navigation.login_activity'),
                    type: 'item',
                    url: '/login-activity',
